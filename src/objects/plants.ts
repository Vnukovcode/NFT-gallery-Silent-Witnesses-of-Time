...
export const createPlant1 = (parent?: Entity) => createPlant({
    name: 'plant1',
    position: new Vector3(8.087072372436523, 0.023927927017211914, 20.254690170288086),
...
export const createPlant2 = (parent?: Entity) => createPlant({
    name: 'plant2',
    position: new Vector3(8.255424499511719, 0.023927927017211914, 10.826957702636719),
